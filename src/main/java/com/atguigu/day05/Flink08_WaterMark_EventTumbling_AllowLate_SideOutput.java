...
public class Flink08_WaterMark_EventTumbling_AllowLate_SideOutput {
    public static void main(String[] args) throws Exception {
        ...
        WindowedStream<WaterSensor, String, TimeWindow> window =
                keyedStream.window(TumblingEventTimeWindows.of(Time.seconds(5))).allowedLateness(Time.seconds(3))
                        // TODO: 侧输出流
        ...
        result.getSideOutput(new OutputTag<WaterSensor>("output"){}).print("侧输出流");
