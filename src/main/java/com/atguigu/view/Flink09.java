...
*/
    ...
    public static class TopNCountFunc extends KeyedProcessFunction<Long,
        ...
        //定义状态
        private ListState<IdCount> listState;

        @Override
        public void open(Configuration parameters) throws Exception {
            listState=
                    getRuntimeContext().getListState(new ListStateDescriptor<IdCount>("list-state",IdCount.class));
        }
        ...
        public void onTimer(long timestamp, OnTimerContext ctx, Collector<String> out) throws Exception {
            ...
            //取出状态中的数据
            Iterator<IdCount> iterator = listState.get().iterator();
